...
const sendBody='There may be times when you see me working in my studio, or you may not. But you can leave me a message by typing in the textbox above and hitting the send button. Your message will be printed by a receipt printer in the studio right next to my desk. I’ll keep an eye on these messages that you leave for me. These will come as anonymous, so be nice and send some love.';
